...
alone in the first cell. MuPDF splits "7.17." from "Clear Key" even when the
...
827 grandMA2 contents rows. The Go port rewrites this parser anyway, so the
tolerance belongs in the parser rather than in line grouping.
"""
