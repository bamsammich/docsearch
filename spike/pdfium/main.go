...
// space: see lines. 0.45em sits between one manual's glyph-positioned footer,
...
// to the page by default and PDFium does not: one manual carries a stray "1"
...
func lines(runs []run, useRendered bool) [][]any {
	...
	// Vertical text, such as an "Author Manuscript" watermark down the margin
	// of every page of some journal PDFs, overlaps every band on the page and
