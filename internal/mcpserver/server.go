...
func New(d Deps) *mcp.Server {
	...
	mcp.AddTool(s, &mcp.Tool{
		Name: "outline",
		Description: "Return a document's heading tree to the given depth. Use this before " +
			"searching to learn the document's own vocabulary, so you can query with the " +
			"terms it actually uses rather than guessing at terminology.",
	}, d.outline)
